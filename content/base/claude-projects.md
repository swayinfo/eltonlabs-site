---
description: "Полное руководство по проектам Claude AI: создание, настройка системных инструкций, работа с файлами, интеграция с Google Drive и GitHub, автоматизация повторяющихся задач"
title: Проекты Claude
---
