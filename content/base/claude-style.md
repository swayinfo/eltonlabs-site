---
description: "Подробное руководство по созданию персональных стилей в Claude AI: психолог, юрист, копирайтер, преподаватель. Настройка custom стилей и автоматизация через текстовые экспандеры"
---
